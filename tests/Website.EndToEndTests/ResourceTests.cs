...
public class ResourceTests : EndToEndTest
{
    ...
    [InlineData("/assets/scripts/main.js", "text/javascript")]
    [InlineData("/assets/scripts/main.js.map", "text/plain")]
    [InlineData("/assets/styles/main.css", "text/css")]
    [InlineData("/assets/styles/main.css.map", "text/plain")]
